...
public class Registro {
    ...
    public boolean agregar(Libro libro) {
        ...
        try {
            ...
            System.out.println("Error en SQL al agregar libro - Clase Registro" + e.getMessage());
            return false;
        }
    }
    ...
    public boolean actualizar(Libro libro) {
        ...
        try {
            ...
            System.out.println("Error en SQL al actualizar libro - Clase Registro" + e.getMessage());
            return false;
        }
    ...
    public boolean eliminar(int idLibro) {
        ...
        try {
            ...
            System.out.println("Error en SQL al eliminar libro - Clase Registro" + e.getMessage());
            return false;
        }
    }
